...
const Login = () => {
  ...
  const handleSubmit=(e)=>{
    ...
    if(email.toLowerCase() === "codebreakers@cb.com" && pass.toLowerCase()==="cb"){
      login({email,pass})
    }else{
      alert("Error Pasword")
    }
          ...
          onSubmit={handleSubmit}
           className="flex flex-col text-left p-3 gap-5">
            <div className="flex flex-col gap-2">
              <label
                className="font-montserrat text-label text-labelColor hover:cursor-pointer hover:after:content-['codebreakers@cb.com'] hover:after:text-black hover:after:pl-3 hover:after:underline"
                htmlFor="email"
              >
                Email
              </label>
            ...
            <div className="flex flex-col gap-2">
              <label
                className="font-montserrat text-label text-labelColor hover:cursor-pointer hover:after:content-['cb'] hover:after:text-black hover:after:pl-3 hover:after:underline"
                htmlFor="pass"
              >
                Password
              </label>
